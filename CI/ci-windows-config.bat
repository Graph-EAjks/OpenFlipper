...
if "%PYTHON%" == "no" (
  ...
  set CMAKE_CONFIGURATION=%QT_BASE_CONFIG% -DQWT6_INCLUDE_DIR=%QWT6_INCLUDE_DIR% -DQWT6_LIBRARY=%QWT6_LIBRARY% -DQWT6_LIBRARY_DIR=%QWT6_LIBRARY_DIR% -DCMAKE_WINDOWS_LIBS_DIR=%CMAKE_WINDOWS_LIBS_DIR% -DPython3_INCLUDE_DIR="C:\Program Files\Python312\include" -DPython3_LIBRARY="C:\Program Files\Python312\libs\python312.lib" -DPython3_EXECUTABLE="C:\Program Files\Python312\python.exe"
)
