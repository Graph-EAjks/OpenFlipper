...
echo "C:\Program Files\CMake\bin\cmake.exe"  -DGTEST_PREFIX="%LIBPATH_BASE%/%ARCHITECTURE%/%GTESTVERSION%" -G "%GENERATOR%" -DPYTHON_EXECUTABLE:FILEPATH=C:\Program Files\Python312\python.exe -DCMAKE_BUILD_TYPE=Debug -DOPENFLIPPER_BUILD_UNIT_TESTS=TRUE %CMAKE_CONFIGURATION% ..

::invoke cmake
"C:\Program Files\CMake\bin\cmake.exe"  -DGTEST_PREFIX="%LIBPATH_BASE%/%ARCHITECTURE%/%GTESTVERSION%" -G "%GENERATOR%" -DPYTHON_EXECUTABLE:FILEPATH=C:\Program Files\Python312\python.exe -DCMAKE_BUILD_TYPE=Debug -DOPENFLIPPER_BUILD_UNIT_TESTS=TRUE %CMAKE_CONFIGURATION% ..
