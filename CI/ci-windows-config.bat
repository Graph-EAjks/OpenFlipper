...
if "%PYTHON%" == "no" (
  ...
  set CMAKE_CONFIGURATION=%QT_BASE_CONFIG% -DQWT6_INCLUDE_DIR=%QWT6_INCLUDE_DIR% -DQWT6_LIBRARY=%QWT6_LIBRARY% -DQWT6_LIBRARY_DIR=%QWT6_LIBRARY_DIR% -DCMAKE_WINDOWS_LIBS_DIR=%CMAKE_WINDOWS_LIBS_DIR% -DPython3_EXECUTABLE=%PYTHON_EXECUTABLE% -DPython3_INCLUDE_DIR=%PYTHON_INCLUDE_DIR% -DPython3_LIBRARY=%PYTHON_LIBRARY%
)
