...
if [ "$QTVERSION" == "qt5.15.1" ]; then
  ...
  OPTIONS="$OPTIONS -DQWT6_INCLUDE_DIR=$HOME/sw/qwt-6.2.0-qt6.5.3/include -DQWT6_LIBRARY_DIR=$HOME/sw/qwt-6.2.0-qt6.5.3/lib -DQWT6_LIBRARY=$HOME/sw/qwt-6.2.0-qt6.5.3/lib/libqwt.so -DQT_INSTALL_PATH=$HOME/sw/Qt/6.5.3/gcc_64"
