...
set PYTHON_INCLUDE_DIR="C:\Program Files\Python312\include"
set PYTHON_LIBRARY="C:\Program Files\Python312\libs\python312.lib"
...
if "%PYTHON%" == "no" (
  ...
  set CMAKE_CONFIGURATION=%QT_BASE_CONFIG% -DQWT6_INCLUDE_DIR=%QWT6_INCLUDE_DIR% -DQWT6_LIBRARY=%QWT6_LIBRARY% -DQWT6_LIBRARY_DIR=%QWT6_LIBRARY_DIR% -DCMAKE_WINDOWS_LIBS_DIR=%CMAKE_WINDOWS_LIBS_DIR% -DPYTHON_EXECUTABLE=%PYTHON_EXECUTABLE% -DPYTHON_INCLUDE_DIR=%PYTHON_INCLUDE_DIR% -DPYTHON_LIBRARY=%PYTHON_LIBRARY%
)
