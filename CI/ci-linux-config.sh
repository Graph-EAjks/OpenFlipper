...
if [ "$QTVERSION" == "qt5.13.0" ]; then
  ...
  QT5_INSTALL_PATH="~/sw/Qt/5.13.0/gcc_64"
  ...
  QT5_INSTALL_PATH="~/sw/Qt/5.12.2/gcc_64"
  ...
  QT5_INSTALL_PATH="~/sw/Qt/5.11.2/gcc_64"
  ...
  QT5_INSTALL_PATH="~/sw/Qt/5.9/gcc_64"
  ...
  QT5_INSTALL_PATH="~/sw/Qt/5.13.2/gcc_64"
  ...
  QT5_INSTALL_PATH="~/sw/Qt/5.15.1/gcc_64"
fi
